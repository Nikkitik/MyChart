...
public class MyBarChartListener extends BarLineChartTouchListener {
    ...
    MyBarChartListener(BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> chart, Matrix touchMatrix, float dragTriggerDistance) {
        super(chart, touchMatrix, dragTriggerDistance);
    }

    void setRef(MyBarChart.Call ref) {
        this.ref = ref;
    }
